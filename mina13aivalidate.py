...
class StringAdjusterApp:
    ...
    def initialize_ui(self):
        ...
        min_entry = tk.Entry(self.master, textvariable=self.range_min_var, validate="key", validatecommand=(self.validate, '%P'))
        ...
        max_entry = tk.Entry(self.master, textvariable=self.range_max_var, validate="key", validatecommand=(self.validate, '%P'))
