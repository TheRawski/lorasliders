...
class StringAdjusterApp:
    ...
    def initialize_ui(self):
        ...
        update_button = tk.Button(self.master, text="Update Sliders", command=self.update_sliders)
    ...
    def initialize_sliders(self):
        ...
        # Destroy existing sliders and labels
    ...
    def update_sliders(self):
        ...
        for index, slider in enumerate(self.sliders):
            current_value = float(self.current_values[index].get())
