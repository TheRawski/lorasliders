...
class StringAdjusterApp:
    ...
    def initialize_ui(self):
        ...
        self.text_box = tk.Text(self.master, height=10, width=100)
        self.text_box.insert(tk.END, self.original_text_var.get())
        self.text_box.grid(row=1, column=0, columnspan=4, pady=5, padx=10, sticky="w")
    ...
    def initialize_sliders(self):
        ...
        for index, match in enumerate(matches):
            ...
            label.grid(row=index + 4, column=0, pady=5, padx=10, sticky="w")
            ...
            slider.grid(row=index + 4, column=1, columnspan=2, pady=5, padx=10, sticky="w")
